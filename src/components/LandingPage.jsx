...
const LandingPage = () => {
  ...
  const fetchStats = async () => {
    try {
      ...
      const usersResponse = await fetch('https://auth-api-xz1q.onrender.com/api/auth/users');
      if (!usersResponse.ok) {
      ...
      const attendanceResponse = await fetch(`https://surveytoolbackend.onrender.com/api/attendance/all?month=${month}&year=${year}`);
